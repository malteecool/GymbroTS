...
INSERT INTO exercise (id, exe_name, exe_user_id, exe_date, exe_max_weight, exe_max_reps, exe_muscle_group) VALUES
  ('e1000001-0000-0000-0000-000000000001', 'Bench Press',      'a0000001-0000-0000-0000-000000000001', NOW(), 100.00, 8,  'chest'),
  ('e1000001-0000-0000-0000-000000000002', 'Overhead Press',   'a0000001-0000-0000-0000-000000000001', NOW(),  70.00, 8,  'shoulders'),
  ('e1000001-0000-0000-0000-000000000003', 'Squat',            'a0000001-0000-0000-0000-000000000001', NOW(), 140.00, 5,  'legs'),
  ('e1000001-0000-0000-0000-000000000004', 'Deadlift',         'a0000001-0000-0000-0000-000000000001', NOW(), 180.00, 3,  'back'),
  ('e1000001-0000-0000-0000-000000000005', 'Pull-up',          'a0000001-0000-0000-0000-000000000001', NOW(),  NULL,  12, 'back'),
  ('e1000001-0000-0000-0000-000000000006', 'Tricep Pushdown',  'a0000001-0000-0000-0000-000000000001', NOW(),  40.00, 12, 'triceps'),
  ('e1000001-0000-0000-0000-000000000007', 'Barbell Row',      'a0000001-0000-0000-0000-000000000001', NOW(),  90.00, 8,  'back');

-- Exercises — Jordan
INSERT INTO exercise (id, exe_name, exe_user_id, exe_date, exe_max_weight, exe_max_reps, exe_muscle_group) VALUES
  ('e2000001-0000-0000-0000-000000000001', 'Low Bar Squat',    'a0000001-0000-0000-0000-000000000002', NOW(), 200.00, 3, 'legs'),
  ('e2000001-0000-0000-0000-000000000002', 'Sumo Deadlift',    'a0000001-0000-0000-0000-000000000002', NOW(), 220.00, 2, 'back'),
  ('e2000001-0000-0000-0000-000000000003', 'Paused Bench',     'a0000001-0000-0000-0000-000000000002', NOW(), 120.00, 5, 'chest'),
  ('e2000001-0000-0000-0000-000000000004', 'Romanian Deadlift','a0000001-0000-0000-0000-000000000002', NOW(), 130.00, 8, 'legs');

-- Exercises — Sam
INSERT INTO exercise (id, exe_name, exe_user_id, exe_date, exe_max_weight, exe_max_reps, exe_muscle_group) VALUES
  ('e3000001-0000-0000-0000-000000000001', 'Treadmill Run',    'a0000001-0000-0000-0000-000000000003', NOW(), NULL,   NULL, 'cardio'),
  ('e3000001-0000-0000-0000-000000000002', 'Cycling',          'a0000001-0000-0000-0000-000000000003', NOW(), NULL,   NULL, 'cardio');
